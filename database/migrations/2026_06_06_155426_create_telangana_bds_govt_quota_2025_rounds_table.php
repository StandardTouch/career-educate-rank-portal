...
class CreateTelanganaBdsGovtQuota2025RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('telangana_bds_govt_quota_2025_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_telangana_bds_govt_quota_2025__f43465_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('telangana_bds_govt_quota_2025_rounds');
    }
}
?>