...
class CreateAllIndiaQuotaBds2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('all_india_quota_bds_2024_rounds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_india_quota_bds_2024_rounds');
    }
}
?>