...
class CreateAllIndiaQuotaBds2023RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('all_india_quota_bds_2023_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_all_india_quota_bds_2023_round_8df014_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('all_india_quota_bds_2023_rounds');
    }
}
?>