...
class CreateChhatisgarhBds2025Table extends Migration
{
    public function up()
    {
        Schema::create('chhatisgarh_bds_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('chhatisgarh_bds_2025');
    }
}
?>