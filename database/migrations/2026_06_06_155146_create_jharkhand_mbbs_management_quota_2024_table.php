...
class CreateJharkhandMbbsManagementQuota2024Table extends Migration
{
    public function up()
    {
        Schema::create('jharkhand_mbbs_management_quota_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('jharkhand_mbbs_management_quota_2024');
    }
}
?>