...
class CreateDeemedUniversitiesQuotaBds2024Table extends Migration
{
    public function up()
    {
        Schema::create('deemed_universities_quota_bds_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deemed_universities_quota_bds_2024');
    }
}
?>