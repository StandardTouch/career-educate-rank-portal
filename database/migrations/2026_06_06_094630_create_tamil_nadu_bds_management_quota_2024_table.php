...
class CreateTamilNaduBdsManagementQuota2024Table extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_bds_management_quota_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tamil_nadu_bds_management_quota_2024');
    }
}
?>