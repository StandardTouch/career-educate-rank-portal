...
class CreateAllIndiaQuotaBds2023Table extends Migration
{
    public function up()
    {
        Schema::create('all_india_quota_bds_2023', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_india_quota_bds_2023');
    }
}
?>