...
class CreateTelanganaBdsManagementQuota2024Table extends Migration
{
    public function up()
    {
        Schema::create('telangana_bds_management_quota_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('telangana_bds_management_quota_2024');
    }
}
?>