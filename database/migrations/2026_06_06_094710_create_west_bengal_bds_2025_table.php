...
class CreateWestBengalBds2025Table extends Migration
{
    public function up()
    {
        Schema::create('west_bengal_bds_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('west_bengal_bds_2025');
    }
}
?>