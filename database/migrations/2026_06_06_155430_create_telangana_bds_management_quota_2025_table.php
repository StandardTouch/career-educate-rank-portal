...
class CreateTelanganaBdsManagementQuota2025Table extends Migration
{
    public function up()
    {
        Schema::create('telangana_bds_management_quota_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('telangana_bds_management_quota_2025');
    }
}
?>