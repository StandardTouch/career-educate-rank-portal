...
class CreateChhattisgarhMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('chhattisgarh_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('chhattisgarh_mbbs_2025');
    }
}
?>