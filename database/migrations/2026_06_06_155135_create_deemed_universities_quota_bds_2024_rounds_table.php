...
class CreateDeemedUniversitiesQuotaBds2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('deemed_universities_quota_bds_2024_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_deemed_universities_quota_bds__0cb626_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('deemed_universities_quota_bds_2024_rounds');
    }
}
?>