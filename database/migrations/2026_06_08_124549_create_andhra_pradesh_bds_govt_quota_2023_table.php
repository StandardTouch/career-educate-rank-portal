...
class CreateAndhraPradeshBdsGovtQuota2023Table extends Migration
{
    public function up()
    {
        Schema::create('andhra_pradesh_bds_govt_quota_2023', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('andhra_pradesh_bds_govt_quota_2023');
    }
}
?>