...
class CreateDeemedUniversitiesQuotaBds2025Table extends Migration
{
    public function up()
    {
        Schema::create('deemed_universities_quota_bds_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deemed_universities_quota_bds_2025');
    }
}
?>