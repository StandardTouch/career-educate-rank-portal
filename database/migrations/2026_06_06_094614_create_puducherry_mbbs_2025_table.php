...
class CreatePuducherryMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('puducherry_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('puducherry_mbbs_2025');
    }
}
?>