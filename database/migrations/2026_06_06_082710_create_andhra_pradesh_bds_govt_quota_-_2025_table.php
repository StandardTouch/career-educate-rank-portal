...
class CreateAndhraPradeshBdsGovtQuota2025Table extends Migration
{
    public function up()
    {
        Schema::create('andhra_pradesh_bds_govt_quota_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('andhra_pradesh_bds_govt_quota_-_2025');
    }
}
?>