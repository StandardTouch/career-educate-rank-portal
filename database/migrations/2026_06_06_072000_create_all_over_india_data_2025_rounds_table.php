...
class CreateAllOverIndiaData2025RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('all_over_india_data_2025_rounds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_over_india_data_2025_rounds');
    }
}
?>