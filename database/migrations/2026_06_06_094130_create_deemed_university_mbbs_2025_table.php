...
class CreateDeemedUniversityMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('deemed_university_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deemed_university_mbbs_2025');
    }
}
?>