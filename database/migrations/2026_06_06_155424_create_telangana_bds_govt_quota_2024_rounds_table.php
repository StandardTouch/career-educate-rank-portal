...
class CreateTelanganaBdsGovtQuota2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('telangana_bds_govt_quota_2024_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_telangana_bds_govt_quota_2024__956dad_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('telangana_bds_govt_quota_2024_rounds');
    }
}
?>