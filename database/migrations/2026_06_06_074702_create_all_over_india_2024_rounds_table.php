...
class CreateAllOverIndia2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('all_over_india_2024_rounds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_over_india_2024_rounds');
    }
}
?>