...
class CreateAndhraPradeshMbbsGovtQuota2024Table extends Migration
{
    public function up()
    {
        Schema::create('andhra_pradesh_mbbs_govt_quota_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('andhra_pradesh_mbbs_govt_quota_2024');
    }
}
?>