...
class CreateTamilNaduMbbsManagementQuota2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_mbbs_management_quota_2024_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_tamil_nadu_mbbs_management_quo_00da83_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('tamil_nadu_mbbs_management_quota_2024_rounds');
    }
}
?>