...
class CreateTamilNaduBdsGovernmentQuota2025Table extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_bds_government_quota_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tamil_nadu_bds_government_quota_2025');
    }
}
?>