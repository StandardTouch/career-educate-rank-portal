...
class CreateTelanganaManagementQuotaMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('telangana_management_quota_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('telangana_management_quota_mbbs_2025');
    }
}
?>