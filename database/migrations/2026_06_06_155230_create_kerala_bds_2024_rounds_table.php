...
class CreateKeralaBds2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('kerala_bds_2024_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_kerala_bds_2024_rounds_228513_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('kerala_bds_2024_rounds');
    }
}
?>