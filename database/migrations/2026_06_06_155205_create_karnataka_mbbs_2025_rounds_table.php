...
class CreateKarnatakaMbbs2025RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('karnataka_mbbs_2025_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_karnataka_mbbs_2025_rounds_cb13f7_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('karnataka_mbbs_2025_rounds');
    }
}
?>