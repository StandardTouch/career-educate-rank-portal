...
class CreateWestBengal2023RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('west_bengal_2023_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_west_bengal_2023_rounds_59727d_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('west_bengal_2023_rounds');
    }
}
?>