...
class CreateUttarakhandBds2025Table extends Migration
{
    public function up()
    {
        Schema::create('uttarakhand_bds_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('uttarakhand_bds_2025');
    }
}
?>