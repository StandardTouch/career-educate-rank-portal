...
class CreateAllIndidaQuotaBds2025Table extends Migration
{
    public function up()
    {
        Schema::create('all_indida_quota_bds_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_indida_quota_bds_2025');
    }
}
?>