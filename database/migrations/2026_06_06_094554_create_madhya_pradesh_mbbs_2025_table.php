...
class CreateMadhyaPradeshMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('madhya_pradesh_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('madhya_pradesh_mbbs_2025');
    }
}
?>