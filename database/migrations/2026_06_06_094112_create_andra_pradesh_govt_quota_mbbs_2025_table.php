...
class CreateAndraPradeshGovtQuotaMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('andra_pradesh_govt_quota_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('andra_pradesh_govt_quota_mbbs_2025');
    }
}
?>