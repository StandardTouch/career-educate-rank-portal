...
class CreateRajasthanBds2025RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('rajasthan_bds_2025_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_rajasthan_bds_2025_rounds_a7590b_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('rajasthan_bds_2025_rounds');
    }
}
?>