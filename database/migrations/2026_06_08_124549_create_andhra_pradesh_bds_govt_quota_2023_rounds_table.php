...
class CreateAndhraPradeshBdsGovtQuota2023RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('andhra_pradesh_bds_govt_quota_2023_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_andhra_pradesh_bds_govt_quota__6d8062_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('andhra_pradesh_bds_govt_quota_2023_rounds');
    }
}
?>