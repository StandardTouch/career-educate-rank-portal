...
class CreateTamilnaduGovtQuotaMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('tamilnadu_govt_quota_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tamilnadu_govt_quota_mbbs_2025');
    }
}
?>