...
class CreateMyRankUttarPradeshDental2024Table extends Migration
{
    public function up()
    {
        Schema::create('my_rank_uttar_pradesh_dental_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('my_rank_uttar_pradesh_dental_2024');
    }
}
?>