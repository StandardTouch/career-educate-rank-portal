...
class CreateUttarPradeshMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('uttar_pradesh_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('uttar_pradesh_mbbs_2025');
    }
}
?>