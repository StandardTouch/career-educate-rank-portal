...
class CreateTelanagaGovtMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('telanaga_govt_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('telanaga_govt_mbbs_2025');
    }
}
?>