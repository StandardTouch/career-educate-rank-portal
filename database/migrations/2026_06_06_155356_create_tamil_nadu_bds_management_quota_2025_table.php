...
class CreateTamilNaduBdsManagementQuota2025Table extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_bds_management_quota_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tamil_nadu_bds_management_quota_2025');
    }
}
?>