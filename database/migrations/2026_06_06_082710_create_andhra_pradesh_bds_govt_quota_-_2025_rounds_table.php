...
class CreateAndhraPradeshBdsGovtQuota2025RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('andhra_pradesh_bds_govt_quota_2025_rounds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('andhra_pradesh_bds_govt_quota_2025_rounds');
    }
}
?>