...
class CreateAllOverIndiaData2025Table extends Migration
{
    public function up()
    {
        Schema::create('all_over_india_data_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('all_over_india_data_2025');
    }
}
?>