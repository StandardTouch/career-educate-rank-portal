...
class CreateTamilNaduMbbsManagementQuota2024Table extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_mbbs_management_quota_2024', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tamil_nadu_mbbs_management_quota_2024');
    }
}
?>