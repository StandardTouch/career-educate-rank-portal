...
class CreateTamilNaduBdsGovernmentQuota2024RoundsTable extends Migration
{
    public function up()
    {
        Schema::create('tamil_nadu_bds_government_quota_2024_rounds', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('round_id');
            $table->foreign('round_id', 'fk_tamil_nadu_bds_government_quot_3163f7_rnd')->references('id')->on('rounds');
    ...
    {
        Schema::dropIfExists('tamil_nadu_bds_government_quota_2024_rounds');
    }
}
?>