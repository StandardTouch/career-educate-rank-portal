...
class CreateUttarakhandMbbs2025Table extends Migration
{
    public function up()
    {
        Schema::create('uttarakhand_mbbs_2025', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('uttarakhand_mbbs_2025');
    }
}
?>