...
<head>
    ...
    <title>Import Analysis - Career Educate</title>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 mt-12">
        <section class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div class="px-6 pt-8 pb-5 border-b border-slate-200 mb-8">
                <p class="text-xs font-bold uppercase tracking-[0.18em] text-rose-500">Excel Analysis Import</p>
                <h1 class="mt-2 text-3xl font-bold text-slate-950">Import Analysis Data</h1>
                <p class="mt-2 text-slate-500 max-w-2xl">
                    Upload an Excel workbook to create or update an analysis page. The data will be stored in dedicated analysis tables.
                </p>
            </div>
            ...
            <form action="{{ route('import.analysis.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6 mt-6">
                ...
                <div>
                    <label for="excel_file" class="block text-sm font-bold uppercase tracking-wide text-slate-600">Analysis Excel File</label>
                    <input
                        id="excel_file"
                        name="excel_file"
                        type="file"
