...
<head>
    ...
    <title>Karnataka Quota MBBS - 2023 Cutoff Analysis</title>
...
<body class="min-h-screen text-slate-800 flex flex-col">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" id="rank-input" placeholder="Enter your NEET 2023 All India rank..."
    ...
    <script>
        ...
        const filterState = {
            ...
            quotas: {
                confirmed: ['any'], // Default set to OPEN as shown in screenshot
                temp: ['any']
            },
            rounds: {
